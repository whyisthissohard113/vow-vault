/**
 * Inline SVG icon set for the Wedding Memory Vault UI.
 *
 * Deliberately dependency-free (no icon library) to keep the dependency
 * surface stable. Icons accept `className` for sizing/coloring and default to
 * `h-5 w-5` stroke icons (24x24 viewBox, currentColor).
 */
...
export function IconWedding({ className }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      <path d="M12 20h9" />
      <path d="M12 4v2" />
      <path d="M4 20l2.5-8h11L20 20" />
      <path d="M6.5 16h11" />
      <path d="M12 4c1.5 0 2.5 1 2.5 2.5S13.5 9 12 10" />
    </svg>
  );
}
...
/** Brand mark — a simple heart-in-ring monogram used across auth/dashboard. */
export function IconBrand({ className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M16 23.5s-6-3.4-6-7.4a2.9 2.9 0 0 1 5-2.1 2.9 2.9 0 0 1 5 2.1c0 4-6 7.4-6 7.4z" />
    </svg>
  );
}